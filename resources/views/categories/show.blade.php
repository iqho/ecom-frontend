    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-center border-bottom border-gray fs-4">
                View All Products by Category : <strong>{{ $category['name'] }}</strong>
            </div>
        </div>
        <div class="card-gallery">
            ...
            <div class="card-content position-relative shadow">
                ...
                <span class="badge bg-danger mt-1" style="font-size: 14px">
                    <a href="{{ route('categories.products', $product['category']['id']) }}" class="text-white">{{ $product['category']['name'] ?? '' }}</a>
                </span>
                <h6 class="mt-2">
