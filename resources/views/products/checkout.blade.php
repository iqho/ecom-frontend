    ...
    <div class="container p-4" id="confirmOrderDiv">
        <div class="row g-0 mb-4 border border-gray">
            <div class="col-md-8 d-flex align-items-center" style="font-size: 18px;">
                <a href="{{ url('/') }}" class="ms-2 font-weight-bold me-1" style="text-decoration: none">Home </a> >
                <span class="ms-1">Order Summary</span>
            </div>
            ...
            <div class="card-body">
                @if (session('success'))
                    <div class="row g-0 mb-2">
                        <div id="success" class="col-12 text-center text-success" style="font-size: 18px">
                            {{ session('success') }}</div>
                    </div>
                @endif
                            ...
                            <table class="table table-bordered align-middle text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="item_sub_total" value="{{ $allItemSubTotal }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="promo_discount_amount" value="{{ $promoCodeAmount }}">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <label for="shipping_address">Shipping Customer Full Address</label>
                                            <textarea name="shipping_address" id="shippingAddress" rows="3" class="form-control">371/A, Block: D, Bashundhara R/A, Baridhara, Dhaka - 1229
                                        </textarea>
                                            <label for="shippingUserMobile" class="mt-2">Shipping Customer
                                                Mobile</label>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <label for="billingUserName">Billing Customer Name</label>
                                            ...
                                            <textarea name="billing_address" id="billingAddress" rows="3" class="form-control">Joybishupur, Sukhia, Pakundia, Kishoreganj - 2326
                                        </textarea>
                                            <label for="billingUserMobile" class="mt-2">Billing Customer
                                                Mobile</label>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class='info' id='info3'>
                                                ...
                                                Secret Code: <input type="number" name="cardSecretCode"
